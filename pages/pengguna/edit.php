    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card spur-card">
                ...
                <div class="card-body ">
                    <form action="<?=base_url() . '/actions/pengguna_action.php' ?>?id=<?=$_GET['id']?>" method="POST">
                        <div class="form-group">
                            <label for="nomor">Nomor (NIK/NIP/NIM) <small class="text-danger">*</small></label>
                            <input type="text" class="form-control" name="nomor" required id="nomor" placeholder="Nomor..." value="<?=$pengguna['nomor']?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" required id="username" minlength="5" placeholder="Username..." value="<?=$pengguna['username']?>">
                        </div>
                        ...
                        <hr>
                        <div class="form-group">
                            <label for="password_baru">Password Baru <small class="text-info">kosongkan jika tidak diubah</small></label>
                            <input type="password" class="form-control" name="password_baru"  minlength="5" id="password_baru"
