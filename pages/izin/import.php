        ...
        <div class="col-md-12">
            <div class="card spur-card">
                <div class="card-header text-right">
                    <div class="spur-card-title"> Import Data Izin</div>
                </div>
                <div class="card-body ">
                    <form action="<?= base_url() . '/actions/izin_action.php' ?>" method="POST" enctype="multipart/form-data">
                        <p class="text-danger">
                            <a href="<?= base_url() . '/assets/excel/format_import_data_izin.xlsx' ?>" target="_blank" class="text-danger">Download format import excel <i class="fas fa-file-excel"></i></a>
                        </p>
